...
import { encrypt, decrypt } from "./client-encryption"
...
export async function verifyAdminCodeClient(code: string): Promise<{ success: boolean; message: string }> {
...
export function getAdminSessionClient(): AdminSession | null {
...
export function logoutAdminClient() {
...
export const verifyAdminCode = verifyAdminCodeClient
export const getAdminSession = getAdminSessionClient
export const logoutAdmin = logoutAdminClient

// Re-export from pure-auth.ts
export * from "./pure-auth"
